...
public class TextAreaOutputStream extends OutputStream {
	...
	public static void setListeners(List<EventListener> listeners) {
		TextAreaOutputStream.listeners = listeners;
	}
	
	public static void setListener(EventListener listener) {
		TextAreaOutputStream.listeners.add(listener);
	}
	...
	static private String bytesToString(byte[] ba, int str, int len) {
		try {
			return new String(ba, str, len, "euc-kr");
...
//					}
			...
			try{
				for(EventListener listener : listeners) listener.log(Arrays.toString(values.toArray()));
			}catch(Exception err){
